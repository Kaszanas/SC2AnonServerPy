...
_SENDNICKNAME = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="nickname",
            full_name="SendNickname.nickname",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_RECEIVEID = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="anonymizedID",
            full_name="ReceiveID.anonymizedID",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
SendNickname = _reflection.GeneratedProtocolMessageType(
    "SendNickname",
    (_message.Message,),
    {
...
ReceiveID = _reflection.GeneratedProtocolMessageType(
    "ReceiveID",
    (_message.Message,),
    {
